...
export const sendTeamLeadWelcomeEmail = async (email, firstName,lastName, userId, password, departmentName) => {
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; padding: 20px; background: #f5f5f5;">
      <div style="max-width: 480px; margin: auto; background: #ffffff; padding: 25px; border-radius: 10px;">
        ...
        <p>Congratulations! You’ve been successfully added as a <b>Team Lead</b> at <b>MH Circle Solutions</b>.</p>
