...
export default function CreateSubtaskPage() {
  ...
  if (status === "loading" || fetchingEmployees || fetchingManagers) {
    return (
          ...
          <div>
            ...
            <p className="text-gray-800 mt-2">
              {shouldShowLeadsField
                ...
                : "Create a new subtask for employees and managers"}
            </p>
          </div>
        </div>
          ...
          <CardContent className="p-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {shouldShowLeadsField && (
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500">
                    Enter the total number of leads/calls/targets to be
                    completed by all assignees
                  </p>
                </div>
              )}
              ...
              <div className="space-y-4">
                ...
                >
                  <TabsList className="grid w-full grid-cols-2 bg-white p-1 rounded-xl shadow-md">
                    <TabsTrigger
                      value="employees"
                      ...
                      <SelectContent className="text-black bg-white max-h-60">
                        {managers.map((manager) => (
                          <SelectItem
                            key={manager._id}
                            value={manager._id}
                            disabled={selectedManagers.some(
                  ...
                  <div className="bg-indigo-50 p-4 rounded-lg">
                    ...
                    <ul className="space-y-2 text-sm text-gray-700">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          <strong>Leads</strong> = Number of calls/tasks/targets
                          to complete
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-2 h-2 bg-indigo-500 rounded-full mt-1.5"></div>
                        <span>
                          Example: 100 calls, 50 emails, 200 follow-ups
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-2 h-2 bg-indigo-500 rounded-full mt-1.5"></div>
                        <span>
                          Each assignee will track their completed leads
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-2 h-2 bg-indigo-500 rounded-full mt-1.5"></div>
