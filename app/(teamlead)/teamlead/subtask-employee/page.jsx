...
export default function CreateSubtaskPage() {
    ...
    const [formData, setFormData] = useState({
        ...
        endTime: "",
        priority: "medium",
        leadsRequired: "0"  // Number of leads/targets required
    });
        ...
        try {
            ...
            const assignedEmployees = selectedEmployees.map(empId => {
                ...
                return {
                    ...
                    status: 'pending',
                    leadsCompleted: 0, // Track individual progress
                    leadsAssigned: Math.ceil(parseInt(formData.leadsRequired) / selectedEmployees.length) // Distribute leads
                };
            });
            ...
            const subtaskData = {
                ...
                leadsCompleted: 0 // Total completed leads
            };
                ...
                <Card className="shadow-2xl shadow-blue-500/10 border-0 bg-gradient-to-br from-white to-blue-50/50 backdrop-blur-sm">
                    ...
                    <CardContent className="p-6">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            {/* Leads Required Field - Simple Number Input */}
                            <div className="space-y-2">
                            ...
                            <div className="flex gap-3 pt-4">
                                ...
                                <Button
                                    type="submit"
                                    disabled={isSubmitting || loading || selectedEmployees.length === 0 || leadsRequired <= 0}
                                    ...
                                    <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                                        ...
                                        <div className="mt-4 p-3 bg-blue-50 rounded-md">
                                            <p className="text-sm text-gray-700">
                                                <span className="font-medium">Example:</span> If each employee completes{' '}
                                                <span className="font-semibold">{leadsPerEmployee} leads</span>, the target of{' '}
                                                <span className="font-semibold">{leadsRequired} leads</span> will be achieved.
                                            </p>
                                        </div>
                                    </div>
                                )}
