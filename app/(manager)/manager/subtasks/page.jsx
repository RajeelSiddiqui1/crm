        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-white">
                <div className="text-center">
                    ...
                    <p className="text-gray-700">You need to be logged in as Manager to access this page.</p>
                </div>
            </div>
        );
    }
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <Card className="border border-gray-200 shadow-sm bg-white">
                                            <CardContent className="p-4">
                                                ...
                                                <Badge className={`${getStatusVariant(selectedSubtask.status)} border flex items-center gap-1 px-3 py-1.5 font-medium w-full justify-center`}>
                                        ...
                                        <Card className="border border-gray-200 shadow-sm bg-white">
                                            <CardContent className="p-4">
                                                ...
                                                <Badge className={`${getPriorityVariant(selectedSubtask.priority)} border flex items-center gap-1 px-3 py-1.5 font-medium w-full justify-center`}>
                                    ...
                                    <Card className="border border-gray-200 shadow-sm bg-white">
                                        ...
                                        <CardContent className="space-y-3">
                                            <div className="flex justify-between items-center">
                                                ...
                                                <span className="font-medium text-black">{formatDate(selectedSubtask.startDate)}</span>
                                            </div>
                                            <div className="flex justify-between items-center">
                                                <span className="text-sm text-black">End Date:</span>
                                                <span className="font-medium text-black">{formatDate(selectedSubtask.endDate)}</span>
                                            </div>
                                            <div className="flex justify-between items-center">
                                                <span className="text-sm text-black">Time:</span>
                                                <span className="font-medium text-black">{selectedSubtask.startTime} - {selectedSubtask.endTime}</span>
                                            </div>
                                            <div className="flex justify-between items-center">
                                                <span className="text-sm text-black">Created:</span>
                                                <span className="font-medium text-xs text-black">{formatDateTime(selectedSubtask.createdAt)}</span>
                                            </div>
                                        </CardContent>
                                    </Card>
                                ...
                                <div className="space-y-6">
                                            ...
                                            <div className="space-y-3">
                                                {selectedSubtask.assignedEmployees && selectedSubtask.assignedEmployees.length > 0 ? (
                                                    selectedSubtask.assignedEmployees.map((emp, index) => (
                                                        <div key={emp.employeeId._id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200">
                                    ...
                                    <Card className="border border-gray-200 shadow-sm bg-white">
                                        ...
                                        <CardContent className="space-y-4">
                                            {selectedSubtask.ManagerFeedback && (
                                                <div>
                                            ...
                                            {selectedSubtask.completedAt && (
                                                <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg border border-green-200">
                                                    <span className="text-sm font-medium text-green-800">Completed At:</span>
                                                    <span className="text-sm text-green-700">{formatDateTime(selectedSubtask.completedAt)}</span>
                                                </div>
                                            )}
                                        </CardContent>
                                    </Card>
                        ...
                        <div className="border-t border-gray-200 bg-gray-50 px-6 py-4">
                            <div className="flex justify-end gap-3">
                                ...
                                <Link href={`/Manager/subtasks/${selectedSubtask._id}`}>
                            ...
                            <div className="text-center py-16">
                                <div>
                                    ...
                                    <h3 className="text-2xl font-bold text-black mb-3">
                                        {subtasks.length === 0 ? "No subtasks created" : "No matches found"}
                                    </h3>
                                ...
                                <Table>
                                    <TableHeader className="bg-gradient-to-r from-gray-50 to-blue-50/50">
                                        <TableRow className="hover:bg-transparent">
                                            <TableHead className="font-bold text-black text-sm uppercase tracking-wide py-4">Subtask Details</TableHead>
                                            <TableHead className="font-bold text-black text-sm uppercase tracking-wide py-4">Parent Submission</TableHead>
                                            <TableHead className="font-bold text-black text-sm uppercase tracking-wide py-4">Status</TableHead>
                                            <TableHead className="font-bold text-black text-sm uppercase tracking-wide py-4">Assigned Employees</TableHead>
                                            ...
                                            >
                                                            ...
                                                            {subtask.assignedEmployees && subtask.assignedEmployees.length > 0 && (
                                                                <div className="flex items-center gap-1 mt-1">
                                                                    ...
                                                                    <span className="text-xs text-gray-700">
                                                                        {subtask.assignedEmployees.length} employee(s)
                                                                    </span>
                                                                </div>
                                                            )}
                                                        </div>
                                                ...
                                                <TableCell className="py-4">
                                                    ...
                                                    <div className="text-xs text-gray-700">
                                                        {subtask.submissionId?.description ?
                                                            subtask.submissionId.description.substring(0, 50) + '...' :
                                                            'No description'
                                                        }
                                                    </div>
                                                </TableCell>
                                                <TableCell className="py-4">
                                                    <Badge className={`${getStatusVariant(subtask.status)} border flex items-center gap-1 px-3 py-1.5 font-medium`}>
                                                    ...
                                                    <div className="flex flex-col gap-1">
                                                        {subtask.assignedEmployees && subtask.assignedEmployees.length > 0 ? (
                                                            subtask.assignedEmployees.slice(0, 3).map((emp, index) => (
                                                                <div key={emp.employeeId._id} className="flex items-center gap-2">
                                                            ...
                                                            <span className="text-xs text-gray-700">No employees assigned</span>
                                                        )}
                                                ...
                                                <TableCell className="py-4">
                                                    <div className="flex gap-2">
                                                        ...
                                                        <Link href={`/manager/subtasks/${subtask._id}`}>
                                                            <Button
                                                                variant="outline"
                                                                size="sm"
