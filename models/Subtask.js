...
const subtaskSchema = new mongoose.Schema({
  ...
  submissionId: { type: mongoose.Schema.Types.ObjectId, ref: "FormSubmission", required: true },
  teamLeadId: { type: mongoose.Schema.Types.ObjectId, ref: "TeamLead", required: true },
  assignedEmployees: [
    {
